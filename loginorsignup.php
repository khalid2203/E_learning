...
<div class="container-fluid bg-dark"> <!-- Start Course Page
Banner -->
    <div class="row">
        <img src="./image/coursebanner.jpg" alt="courses" style="height:300px; width:100%; object-fit:cover;
box-shadow:10px;" />
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6 offset-md-1">
            ...
            <form role="form" id="stuRegForm">
                ...
                <div cLass="form-group">
                    <i class="fas fa-envelop"></i><label for="stuemail" class="pl-2 font-weight-bold">Email</label><small id="statusMsg2"></small><input type="email" class="form-control" placeholder="Email" name="stuemail" id="stuname">
                    <small id="form-text">We'll never share your email with anyone else.</small>
                </div>
                <div cLass="form-group">
