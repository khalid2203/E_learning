...
if (isset($_REQUEST['courseSubmitBtn'])) {
    if (($_REQUEST['course_name'] == "") || ($_REQUEST['course_desc'] == "") || ($_REQUEST['course_duration'] == "") || ($_REQUEST['course_author'] == "") || ($_REQUEST['course_price'] == "") || ($_REQUEST['course_original_price'] == "")) {
...
<div class="col-sm-6 mt-5 mx-3 jumbotron">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label for="course_duration">Author</label>
        ...
        <div class="form-group">
            ...
            <input type="file" class="form-control-gile" id="course_img" name="course_img">
        </div>
