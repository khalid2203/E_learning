...
<div class="col-sm-6 mt-5 mx-3 jumbotron">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        <div class="form-group">
            ...
            <input type="text" readonly class="form-control" id="course_id" name="course_id" value="<?php if (isset($_SESSION['course_id'])) {
                                                                                                echo $_SESSION['course_id'];
                                                                                            } ?>">
        </div>
        <div class="form-group">
            <label for="course_name">Course Name</label>
            <input type="text" readonly class="form-control" id="course_name" name="course_name" value="<?php if (isset($_SESSION['course_name'])) {
        ...
        <div class="form-group">
            ...
            <textarea type="text" class="form-control" id="lesson_desc" name="lesson_desc" rows="2"></textarea>
        </div>
        <div class="form-group">
